...
class CircuitGraph:
    ...
    def draw_topological_graph(self):
        ...
        legend_handles = [plt.Line2D([0], [0], marker='o', color='w', label=label, markerfacecolor=color, markersize=10) for color, label in zip(unique_colors, legend_labels)]
        ...
        ax.legend(handles=legend_handles, labels=legend_labels, title='Logic Value', loc='upper right')
